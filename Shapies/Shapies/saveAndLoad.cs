...
namespace Shapies
{
    internal class saveAndLoad
    {
        ...
        {
            System.IO.File.WriteAllText(@"C:\Users\msaif\Source\Repos\saif01khan01\ShapeAssignment\Shapies\Shapies\formProgram.txt", tosave);
        }
        /**
       * 
       ...
       */
        ...
        {
            t.Text = File.ReadAllText(@"C:\Users\msaif\Source\Repos\saif01khan01\ShapeAssignment\Shapies\Shapies\formProgram.txt");
        }
    }
}
